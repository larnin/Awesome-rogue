...
private:
    ...
    void generatePaterns(Patern::RoomType type, const sf::Vector2u & minSize, const sf::Vector2u & maxSize);
    ...
    const Patern & getPatern(const sf::Vector2u & maxSize, const sf::Vector2u & minSize, Patern::RoomType type);
